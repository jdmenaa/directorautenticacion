...
@Service("processResultsNotificationPush:1.0")
public class ProcessResultsNotificationPushService extends DinersServiceJavaBasedService {
    ...
    public String getServiceId() {
        return "processResultsNotificationPush";
    }
    ...
    private static final String[] KEYS = new String[]{"idUniken", "responseCode", "notificationUuid", "actionResponse", "errorCode", "errorMessage", "status", "deliveryStatus", "isDsVerified", "msgId", "createTs", "updateTs", "expiryTimestamp", "clientIpAddress"};
    ...
    private String sendNotification(String sessionId, String body) {
        ...
        OutputEntity response = this.notificationService.resultNotification(sessionId, inputEntity);
