...
@Service("deleteDeviceManagement:1.0")
public class DeleteDeviceManagementService extends DinersServiceJavaBasedService{
	...
	public String channelToBackend(String request) {
		try {
			...
			RestRequest bak = new RestRequest("xmlns:int=https://msd-gfr-gdd-gestion-dispositivos-cal-dinersclub-migracion-cal.apps.din-ros-can-dev.9gqx.p1.openshiftapps.com/fraude/v1/dispositivos/elimina");
			...
			bak.openTag("variables");
				bak.mapBody("nombreDispositivo","variables/deviceName");
			bak.closeTag();
