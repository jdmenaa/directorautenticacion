...
@Service("processLockUnlockDeviceManagement:1.0")
public class ProcessLockUnlockDeviceManagementService extends DinersServiceJavaBasedService{
	...
	public String getServiceId() {
		return "processLockUnlockDeviceManagement";
	}
	...
	public String channelToBackend(String request) {
		try {
			...
			RestRequest bak = new RestRequest("xmlns:int=https://msd-gfr-gdd-gestion-dispositivos-cal-dinersclub-migracion-cal.apps.din-ros-can-dev.9gqx.p1.openshiftapps.com/fraude/v1/dispositivos/actualiza-estado");
			...
			bak.mapOptionalBody("identificacionUsuario","customer/customerId");
			bak.mapOptionalBody("perfil","customer/profile");
			...
			bak.mapOptionalBody("codigoTransaccion","transaction/code");
